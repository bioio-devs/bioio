...
[See the full documentation on our GitHub pages site](https://bioio-devs.github.io/bioio/)

## Example Usage (see full documentation for more examples)

Assumptions for the below example ([if untrue, see full documentation for more examples](https://bioio-devs.github.io/bioio/)):
* File is an OME TIFF

...
EXTREMELY_LAZY_TEMPORARY_TEST_FILE_LIST = [
    "example.txt"
]
...
def download_test_resources(args: Args):
    ...
    try:
        ...
        resources_dir = (
            Path(__file__).parent.parent / "bioio" / "tests" / "resources"
        ).resolve()
        ...
        for file_name in EXTREMELY_LAZY_TEMPORARY_TEST_FILE_LIST:
            package["resources"][file_name].fetch(resources_dir / file_name)
